...
\begin{align}
f = \frac{1}{4}\abs{\frac{2\eta}{\lambda_2}} = \frac{1}{4}\abs{\frac{-8}{1}}= 2
\end{align}
...
\begin{table}[!ht]
\begin{center}
\begin{tabular}{ | m{3.5cm} | m{1.5cm}| m{2.5cm} | } 
\hline
Parameter & Symbol & Value \\
\hline
Vertex & $\vec{c}$ & \myvec{0\\0} \\ 
\hline
Focal Length & $f$ & 2 \\ 
\hline
Focus & $\vec{F}$ & \myvec{2\\0} \\
\hline
Axis &  & $\myvec{0 & 1}\vec{x} = 0$ \\
\hline
Directrix & & $\myvec{1 & 0}\vec{x} = -2$ \\
\hline
Latus rectum & & $\myvec{1 & 0}\vec{x} = 2$ \\
\hline
End points of latus rectum & $\vec{M},\vec{N}$ & $\myvec{2\\4},\myvec{2\\-4}$ \\
\hline
Length of latus rectum & $l$ & 8 \\
\hline
\end{tabular}
\end{center}
