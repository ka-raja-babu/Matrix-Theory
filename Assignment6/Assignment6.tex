...
\end{lemma}
\begin{proof}
From \eqref{eq:23},parameter $\vec{a}$ of parabola can be calculated as
\begin{align}
\vec{a} &= \frac{-2\eta\myvec{1 & 0}}{4} 
\end{align}
...
\end{lemma}
\begin{proof}
Substituting $x=\beta$ in \eqref{eq:15},we get two values of $y$
\begin{align}
    y_1 , y_2 \label{eq:30}
\end{align}
Using \eqref{eq:30},end points of latus rectum can be calculated as
\begin{align}
    \vec{M}&=\myvec{\beta \\ y_1} \label{eq:17}
    \\
    \vec{N}&=\myvec{\beta \\ y_2} \label{eq:18}
\end{align}
\end{proof}
