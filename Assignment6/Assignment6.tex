...
\hline
Direct- \newline rix normal \newline vector & $\vec{v_1}$ & \myvec{1 \\ 0} & $\vec{v_1}\vec{v}^T$ = 0 \\
\hline
Direct- \newline rix & & $\myvec{1 & 0}\vec{x} = -2$ & $\vec{v_1}^T\vec{x} = -\beta$ \\
\hline
Latus \newline rectum \newline normal \newline vector & $\vec{v_2}$ & $\myvec{1 \\ 0}$ & $\vec{v_2}\vec{v}^T$ = 0 \\ 
\hline
Latus \newline rectum & & $\myvec{1 & 0}\vec{x}=2$ & $\vec{v_2}^T\vec{x}=\beta$\\
\hline
...
\begin{align}
\vec{v_1}\vec{v}^T = 0 \quad (\text{$\vec{v_1}$ is normal vector}) \label{eq:19}
\end{align}
...
\begin{align}
    \vec{v_2}\vec{v}^T = 0 \quad (\text{$\vec{v_2}$ is normal vector}) \label{eq:20}
\end{align}
