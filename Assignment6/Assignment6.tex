...
Now,the vertex $\vec{c}$ is given by
\begin{align}
...
Now,the focal length is given by
\begin{align}
\frac{1}{4}\abs{\frac{2\eta}{\lambda_2}} = \frac{1}{4}\abs{\frac{-8}{1}}= 2
\end{align}

Now,the focus is given by
\begin{align}
\vec{F}^T &= \frac{-2\eta\myvec{1 & 0}}{4} 
\\
\implies \vec{F}^T &= \myvec{2 & 0}
\\
...
\\
$\therefore$
Axis of given parabola is 
\begin{align}
y = 0
\end{align}

$\because$
Vertex of parabola is at equal distance from focus and the directrix and is perpendicular to axis.
\\
$\therefore$
Directrix of given parabola is 
\begin{align}
x = -2
\end{align}
...
\\
$\therefore$
Latus rectum of given parabola is 
\begin{align}
x = 2
\end{align}
