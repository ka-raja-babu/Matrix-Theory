...
\\
Let after time $t$ ,bullet hits the fighter plane such that horizontal distance travelled by plane and bullet is equal.
\\
$\therefore$
\begin{align}
...
\caption{Plane and Bullet}
\label{fig:Plane and Bullet}	
\end{figure}
