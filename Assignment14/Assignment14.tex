...
Let $p$ be the number of occurrence of particular value of $x$ in $X$ such that
\begin{align}
    p &= \comb{n}{r}
\end{align}
where
\begin{align}
    n &= \text{No. of tosses} \\
    r &= \text{No. of 2 or -1.5 of $X_i$ required to get $x$}
\end{align}

Hence,$p$ is given by
\begin{align}
    p &= \{\comb{3}{3},\comb{3}{2},\comb{3}{1},\comb{3}{0} \} \\
    \implies p &= \{1,3,3,1 \} \label{eq5}
\end{align}

Using eq.\eqref{eq5},probability of $X$ is given by
\begin{align}
    \pr{X=x} &= \cbrak{\frac{1}{8},\frac{3}{8},\frac{3}{8},\frac{1}{8}}
\end{align}
