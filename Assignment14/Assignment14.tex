...
Assuming a fair coin,the probability mass function of $X$ is given by
\begin{align}
   \pr{r,n,p} &= \frac{n!}{r!(n-r)!}p^r q^{n-r}
\end{align}
where
\begin{align}
    n=3,p=\frac{1}{2},q=\frac{1}{2},r=0,1,2,3
\end{align}
...
$r$ & 0 & 1 & 2 & 3 \\
\hline
\pr{r} & $\frac{1}{8}$ & $\frac{3}{8}$ & $\frac{3}{8}$ & $\frac{1}{8}$ \\
\hline
\end{tabular}
\caption{PMF of $X$}
\label{tab:table1}
